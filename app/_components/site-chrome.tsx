  ...
  return (
    <footer className="flex flex-col gap-3 border-t border-border py-6 text-xs leading-relaxed text-muted-foreground sm:flex-row sm:items-center sm:justify-between">
      ...
      <nav className="flex flex-wrap gap-x-4 gap-y-2" aria-label="Footer navigation">
        <Link className="rounded hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/50" href="/about">
          About
        </Link>
        <Link className="rounded hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/50" href="/contact">
          Contact
        </Link>
        <Link className="rounded hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/50" href="/privacy">
          Privacy
        </Link>
        <a
          className="rounded hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/50"
